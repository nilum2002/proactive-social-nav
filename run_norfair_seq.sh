#!/usr/bin/env bash
# Norfair tracker, sequential variant.
#
#   node   : norfair_inf_server_node
#   params : ros2_ws/src/benchmark/config/norfair_params.yaml
#
...
#   ./run_norfair_seq.sh publish_static_tf:=false
...
ros2 launch benchmark norfair_server.launch.py "$@"
