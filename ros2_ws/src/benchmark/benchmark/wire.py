"""Wire format shared by inf_client_udp (robot) and the UDP benchmark node.

This module is the contract. It must stay byte-identical to inf_server_udp's
copy -- copy it alongside perception_udp.proto, never fork it.
