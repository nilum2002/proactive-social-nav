...
def generate_launch_description():
    """Sequential UDP benchmark server."""
    package_name = 'benchmark'

    config_path = os.path.join(
        get_package_share_directory(package_name), 'config', 'udp_params.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='benchmark_udp_map_odom_tf',
