...
def generate_launch_description():
    ...
    config_path = os.path.join(
        get_package_share_directory(package_name), 'config', 'norfair_params.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='norfair_server_node',
            name='norfair_inf_server_node',
            output='screen',
        ...
        Node(
            ...
            name='norfair_server_map_odom_tf',
