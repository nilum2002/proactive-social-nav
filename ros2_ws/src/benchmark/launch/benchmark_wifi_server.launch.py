...
def generate_launch_description():
    """Sequential WiFi/DDS benchmark server."""
    package_name = 'benchmark'

    config_path = os.path.join(
        get_package_share_directory(package_name), 'config', 'wifi_params.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='wifi_server_node',
            name='inf_server_wifi_node',
            output='screen',
        ...
        Node(
            ...
            name='benchmark_wifi_map_odom_tf',
