...
def generate_launch_description():
    ...
    config_path = os.path.join(
        get_package_share_directory(package_name), 'config', 'wifi_pipelined_params.yaml')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='wifi_pipelined_node',
            name='inf_server_wifi_pipelined_node',
            output='screen',
        ...
        Node(
            ...
            name='benchmark_wifi_pipelined_map_odom_tf',
        ...
        Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            name='benchmark_wifi_pipelined_laser_tf',
